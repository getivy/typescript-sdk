...
export class Augustus {
   ...
   * @param {string | undefined} [opts.env=process.env['AUGUSTUS_ENV']]
   * @param {string} [opts.baseURL=process.env['AUGUSTUS_BASE_URL'] ?? https://api{env}.getivy.de] - Override the default base URL for the API.
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api{env}.getivy.de';
  }
