...
import * as RedeliverAPI from './redeliver';
import { Redeliver, RedeliverCreateResponse } from './redeliver';
...
export class WebhookDeliveries extends APIResource {
  redeliver: RedeliverAPI.Redeliver = new RedeliverAPI.Redeliver(this._client);
...
WebhookDeliveries.Redeliver = Redeliver;
...
export declare namespace WebhookDeliveries {
  ...
  export { Redeliver as Redeliver, type RedeliverCreateResponse as RedeliverCreateResponse };
}
