...
export interface AccountCreateResponse {
   ...
   */
  financial_addresses: Array<AccountCreateResponse.UnionMember0 | AccountCreateResponse.UnionMember1 | AccountCreateResponse.UnionMember2>;
...
export namespace AccountCreateParams {
  ...
  export interface BeneficiaryData {
     ...
     */
    identification: BeneficiaryData.UnionMember0 | BeneficiaryData.UnionMember1 | BeneficiaryData.UnionMember2;
