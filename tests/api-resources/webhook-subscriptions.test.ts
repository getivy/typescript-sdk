...
describe('resource webhookSubscriptions', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.webhookSubscriptions.create({ events: ['payout.created'], url: 'https://example.com' });
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.webhookSubscriptions.create({ events: ['payout.created'], url: 'https://example.com' });
  });
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.webhookSubscriptions.list({ cursor: 'cursor', limit: 2 }, { path: '/_stainless_unknown_path' }))
      .rejects
